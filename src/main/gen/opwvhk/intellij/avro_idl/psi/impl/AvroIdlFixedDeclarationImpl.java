...
public class AvroIdlFixedDeclarationImpl extends AvroIdlNamedSchemaDeclarationImpl implements AvroIdlFixedDeclaration {

  public AvroIdlFixedDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
