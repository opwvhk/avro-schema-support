...
public class AvroIdlNamespacePropertyImpl extends AvroIdlSchemaPropertyImpl implements AvroIdlNamespaceProperty {

  public AvroIdlNamespacePropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull AvroIdlVisitor visitor) {
    visitor.visitNamespaceProperty(this);
  }
