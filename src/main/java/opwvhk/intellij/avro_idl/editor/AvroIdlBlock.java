...
public class AvroIdlBlock extends AbstractBlock {
	...
	private static final TokenSet ELEMENTS_THAT_MAY_CONTAIN_CHILDREN = TokenSet.create(ARRAY_TYPE, DECIMAL_TYPE, MISPLACED_DOCUMENTATION, DOCUMENTATION,
		ENUM_BODY, ENUM_CONSTANT, ENUM_DECLARATION, ENUM_DEFAULT, FIELD_DECLARATION, FIXED_DECLARATION, FORMAL_PARAMETER, IMPORT_DECLARATION, IMPORT_TYPE,
		JSON_ARRAY, JSON_OBJECT, JSON_PAIR, JSON_VALUE, MAP_TYPE, MESSAGE_ATTRIBUTES, MESSAGE_ATTRIBUTE_THROWS, MESSAGE_DECLARATION, NAMED_SCHEMA_DECLARATION,
