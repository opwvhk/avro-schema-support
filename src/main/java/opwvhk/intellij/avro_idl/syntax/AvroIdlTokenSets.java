...
public class AvroIdlTokenSets {
	public static final TokenSet COMMENTS = TokenSet.create(LINE_COMMENT, BLOCK_COMMENT, BLOCK_COMMENT_START,
			INCOMPLETE_BLOCK_COMMENT, DOC_COMMENT, INCOMPLETE_DOC_COMMENT);
